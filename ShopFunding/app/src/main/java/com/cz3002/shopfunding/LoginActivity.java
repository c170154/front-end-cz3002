...
public class LoginActivity extends AppCompatActivity {
    ...
    private class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            return User.login(LoginActivity.this, mUsername, mPassword);
        }

        @Override
        protected void onPostExecute(final String jwt_token) {
            mAuthTask = null;
            showProgress(false);

            if (jwt_token != null) {
                User.storeJWTToken(LoginActivity.this, jwt_token);
